//***
// Author: Nate
// Description: Graph.cs is a generic class for graphs which can be useful for pathfinding and similar things
//***
...
namespace FoxHerding.Generics
{
    ...
    public class Graph<T>
    {
        ...
        //recursive
        private void DepthFirstSearchHelper(T vertex, HashSet<T> visited, ICollection<T> result)
        {
            visited.Add(vertex);
            result.Add(vertex);
            foreach (T neighbor in _adjacencyList[vertex])
